...
baseFileName = './shellScripts/sparse050_10class_'
baseSimTag = 'sparse050_10class_'
...
for excRat in [0.5]:
    for lr in [0.01]:
        for w1_std in [0.0005, 0.00075, 0.001, 0.002, 0.003, 0.004, 0.005, 0.075, 0.01, 0.0125, 0.015, 0.0175, 0.02, 0.025, 0.03, 0.04, 0.05, 0.06, 0.07]:
