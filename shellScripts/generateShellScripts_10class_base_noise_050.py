...
baseFileName = './shellScripts/sparse050_10class_noise_base_'
baseSimTag = 'sparse050_10class_noise_base_'
        ...
        for noise in [0.00001, 0.00005, 0.0001, 0.0005, 0.001, 0.005, 0.01, 0.00006, 0.00007, 0.00008, 0.00009, 0.0002, 0.0003, 0.0004]:
            for trial in [0,1]:
                ...
                command = generateCommandPreLoadWeights(trial_num=trial,
                        ...
                        exc_hid_rat=excRat,
                        learning_rate=lr,
                        w1_pre_load_id='sparse050_10class_116_t0_w1_init_',
                        w1_pre_load_folder='./base_noise_weights',
                        w2_pre_load_id='sparse050_10class_116_t0_w2_init_',
