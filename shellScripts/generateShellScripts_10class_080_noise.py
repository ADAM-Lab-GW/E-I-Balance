...
baseFileName = './shellScripts/sparse080_10class_noise_'
baseSimTag = 'sparse080_10class_noise_'
...
for excRat in [0.80]:
    for lr in [0.01]:
        for w1_std in [0.001]:
            for noise in [0.00005, 0.00006, 0.00007, 0.00008, 0.00009, 0.0001, 0.0002, 0.0003, 0.0004, 0.0005, 0.001, 0.01]:
